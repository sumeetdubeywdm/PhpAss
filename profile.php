...
<div class="py-5">
 ...
 <div class="form_container">
  ...
  $row=$fetchUserDetails->fetch_user($_SESSION['userid']);
 	...
 	<hr>
 	<div class="row"> 
 		<div class="col-sm-4"><div class="field">Name:</div> </div>
 		<div class="col-sm-8"><?php echo $row['fullname'];?></div>
 	</div>
 	<hr>
 	<div class="row"> 
 		<div class="col-sm-4"><div class="field">UserName:</div></div>
 	...
 	<hr>
     <div class="row"> 
 		<div class="col-sm-4"><div class="field">Phone Number : </div></div>
 		<div class="col-sm-8"><?php echo $row['userPhoneNumber'];?></div>
 	</div>
 	<hr>
     <div class="row"> 
 		<div class="col-sm-4"><div class="field">Gender : </div></div>
